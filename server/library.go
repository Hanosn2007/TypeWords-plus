...
func (s *server) routes() *http.ServeMux {
	...
	mux.HandleFunc("DELETE /api/sync/history/{id}", s.withUser(s.syncHistory))
	mux.HandleFunc("POST /api/sync/history/{id}/undo", s.withUser(s.syncHistory))
	mux.HandleFunc("GET /api/sync/receipts/{id}", s.withUser(s.syncReceipt))
