...
Historical TypeWords documentation, preserved for attribution and reference. This describes the upstream project, not the current TypeWords Plus service. See [the current README](../README.md).
